...
- (void)getListDownloadedRingtonesFromDB;
{
    ...
    NSError *error = nil;
    _arrDownloadedRingtones = [[[DatabaseManager defaultManager]selectRingtoneFromDBError:&error] retain];
...
//								 object:dict];
    ...
    [[DownloaderManager defaultManager]addRequestToQueueFromDict:dict];
